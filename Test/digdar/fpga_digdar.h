...
/** OSC FPGA Slow Channel A input signal buffer offset */
#define OSC_FPGA_XCHA_OFFSET    0x30000
/** OSC FPGA Slow Channel B input signal buffer offset */
...
typedef struct osc_fpga_reg_mem_s {
    ...
    /* XChA & XChB data - 12 LSB bits valid starts from 0x30000 and
